...
| <img src="freecad/franky/resources/icons/brackets.svg" alt="VarSet Quick Edit icon" width="24"> | **VarSet Quick Edit** | Quickly edit variable set groups, values, expressions, and tooltips. |
