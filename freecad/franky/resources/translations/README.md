...
at <https://crowdin.com/project/freecad-addons> webpage and find the **Franky** project.
...
once done, look for the **Franky** project.
...
Now you can contribute your translated `.ts` file to **Franky** repository,
